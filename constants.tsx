...
import { CreditPlan, AspectRatio } from './types';
...
export const ASPECT_RATIOS = [
  { label: 'Square', value: AspectRatio.SQUARE, icon: '▢' },
  { label: 'Landscape', value: AspectRatio.LANDSCAPE, icon: '▭' },
  { label: 'Portrait', value: AspectRatio.PORTRAIT, icon: '▯' },
  { label: 'Classic', value: AspectRatio.CLASSIC, icon: '◫' },
];
